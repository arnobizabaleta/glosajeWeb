                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <td>
                                            <a href="./editCat.php?id=<?php echo $row['codCategoria']; ?>" class="btn btn-primary">
                                                <i class="fas fa-marker"></i>
                                            </a>
                                            <a href="../controladores/deleteCat.php?id=<?php echo $row['codCategoria']; ?>" class="btn btn-danger">
                       ...
                       <div class="row">
                            <div class="col mb-4">
                                   ...
                                   <div class="card card-body">
                                       <form action="../controladores/createCat.php" method="post">
                                           ...
                                           <input type="submit" class="btn btn-primary"value="Agregar categoria" name="createCat">
                                       </form>
                                   </div>
                           </div>
                       </div>
